...
{
public:
    virtual bool ProcessMessages(CNode* pnode, std::atomic<bool>& interrupt, uint32_t& nLocalCompletedTxPerInterval, uint32_t& nLocalTotalFailedTxPerInterval, const uint threadIdx, std::stringstream& latencySS) = 0;
