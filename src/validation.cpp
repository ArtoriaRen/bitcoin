...
{
    /* The client should not call this function during test, so we use -1 as a dummy output shard id.*/
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    /* The connect should not check tx inputs when reconsider blocks because some txinput are generated by
     * tx in new blocks and thus not exist in the chainstate where we have assigned affinity for all coins.
     */ 
    std::vector<int> prevheights;
    CAmount nFees = 0;
    int nInputs = 0;
...
//
//	/*
//	 * The client should only replay tx and not process tx by itself. Thus it
//	 * should not update coins.
//	 */
